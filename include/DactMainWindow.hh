...
private slots:
	...
	*/
	...
	/*!
	 Called by d_entryMap when it has found a file which matches the filter query.
	 entryFound adds that entry to the file list.
	 \param entry relative path used by the corpus reader to the found file
	 */
